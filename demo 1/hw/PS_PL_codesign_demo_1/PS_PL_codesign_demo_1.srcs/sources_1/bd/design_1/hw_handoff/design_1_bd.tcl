...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.GPIO2_BOARD_INTERFACE {pl_sw_1bit} \
   CONFIG.GPIO_BOARD_INTERFACE {pl_led_r} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports pl_led_r] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports pl_sw_1bit] [get_bd_intf_pins axi_gpio_0/GPIO2]
