...
proc create_root_design { parentCell } {
  ...
  # Create instance: wave_gen1_0, and set properties
  set block_name wave_gen1
  set block_cell_name wave_gen1_0
  if { [catch {set wave_gen1_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $wave_gen1_0 eq "" } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins wave_gen1_0/i_clk]
  ...
  connect_bd_net -net wave_gen1_0_o_en [get_bd_pins processing_system7_0/Core0_nIRQ] [get_bd_pins wave_gen1_0/o_en]
