...
HD_PWD='C:/Users/39389/Desktop/Vivado_Workspace/PLtoPS_demo_3.1/PLtoPS_demo_3.1.runs/PLtoPSInterrupt_PLtoPSinterrupt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PLtoPSInterrupt_PLtoPSinterrupt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PLtoPSInterrupt_PLtoPSinterrupt_0_0.tcl
