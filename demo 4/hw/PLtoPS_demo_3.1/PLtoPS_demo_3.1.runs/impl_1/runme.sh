...
HD_PWD='C:/Users/39389/Desktop/Vivado_Workspace/PLtoPS_demo_3.1/PLtoPS_demo_3.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PLtoPSInterrupt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PLtoPSInterrupt_wrapper.tcl -notrace
