...
--               c:/Users/39389/Desktop/Vivado_Workspace/PLtoPS_demo_3.1/PLtoPS_demo_3.1.srcs/sources_1/bd/PLtoPSInterrupt/ip/PLtoPSInterrupt_PLtoPSinterrupt_0_0/PLtoPSInterrupt_PLtoPSinterrupt_0_0_sim_netlist.vhdl
...
entity PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S00_AXI : entity is "PLtoPSinterrupt_v1_0_S00_AXI";
end PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S00_AXI;

architecture STRUCTURE of PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S00_AXI is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S_AXI_INTR is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S_AXI_INTR : entity is "PLtoPSinterrupt_v1_0_S_AXI_INTR";
end PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S_AXI_INTR;

architecture STRUCTURE of PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S_AXI_INTR is
...
\intr[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\intr[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\intr[0]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\intr_counter[0]_i_9\: unisim.vcomponents.LUT6
    generic map(
...
\intr_counter[4]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE00"
    )
        port map (
...
\intr_counter[4]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE00"
    )
        port map (
...
\intr_counter[4]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5554"
    )
        port map (
...
\intr_counter[4]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5554"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0 is
  port (
    s00_axi_wready : out STD_LOGIC;
    s00_axi_awready : out STD_LOGIC;
    s00_axi_arready : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0 : entity is "PLtoPSinterrupt_v1_0";
end PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0;

architecture STRUCTURE of PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0 is
begin
PLtoPSinterrupt_v1_0_S00_AXI_inst: entity work.PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S00_AXI
     port map (
...
PLtoPSinterrupt_v1_0_S_AXI_INTR_inst: entity work.PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0_S_AXI_INTR
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PLtoPSInterrupt_PLtoPSinterrupt_0_0 is
  port (
    irq : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of PLtoPSInterrupt_PLtoPSinterrupt_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of PLtoPSInterrupt_PLtoPSinterrupt_0_0 : entity is "PLtoPSInterrupt_PLtoPSinterrupt_0_0,PLtoPSinterrupt_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of PLtoPSInterrupt_PLtoPSinterrupt_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of PLtoPSInterrupt_PLtoPSinterrupt_0_0 : entity is "PLtoPSinterrupt_v1_0,Vivado 2019.2";
end PLtoPSInterrupt_PLtoPSinterrupt_0_0;

architecture STRUCTURE of PLtoPSInterrupt_PLtoPSinterrupt_0_0 is
...
U0: entity work.PLtoPSInterrupt_PLtoPSinterrupt_0_0_PLtoPSinterrupt_v1_0
     port map (
      irq => irq,
      s00_axi_aclk => s00_axi_aclk,
