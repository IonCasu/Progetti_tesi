...
--Command     : generate_target PLtoPSInterrupt_wrapper.bd
...
entity PLtoPSInterrupt_wrapper is
  port (
...
end PLtoPSInterrupt_wrapper;

architecture STRUCTURE of PLtoPSInterrupt_wrapper is
  component PLtoPSInterrupt is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component PLtoPSInterrupt;
begin
PLtoPSInterrupt_i: component PLtoPSInterrupt
     port map (
