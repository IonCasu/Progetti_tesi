...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PMOD2_D0_N [ create_bd_port -dir O PMOD2_D0_N ]
  set PMOD2_D0_P [ create_bd_port -dir O -type clk PMOD2_D0_P ]
  set S_in_0 [ create_bd_port -dir I S_in_0 ]

  # Create instance: axi_espulsore_0, and set properties
  set axi_espulsore_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_espulsore:1.0 axi_espulsore_0 ]
  set_property -dict [ list \
   CONFIG.EJECTOR_PREAMBLE_DEFAULT_VALUE {4622} \
 ] $axi_espulsore_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports ARDUINO_A0] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_espulsore_0/S00_AXI] [get_bd_intf_pins axi_smc/M00_AXI]
  ...
  connect_bd_net -net S_in_0_1 [get_bd_ports S_in_0] [get_bd_pins axi_espulsore_0/S_in]
  connect_bd_net -net axi_espulsore_0_S_out [get_bd_ports PMOD2_D0_N] [get_bd_pins axi_espulsore_0/S_out]
  connect_bd_net -net axi_espulsore_0_tx_clock [get_bd_ports PMOD2_D0_P] [get_bd_pins axi_espulsore_0/tx_clock]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_espulsore_0/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_espulsore_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_espulsore_0/S00_AXI/S00_AXI_reg] -force
